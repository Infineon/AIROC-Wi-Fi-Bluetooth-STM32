...
#endif
/**
* \addtogroup group_netxduo_whd_port NetXDuo and WHD port
* \{
*
 ...
 *
 * @return CY_RSLT_SUCCESS if the registration was successful; returns \ref generic_netxduo_whd_port_defines otherwise.
 *
 */
