...
/** GPIO events irq handler.  This function calls the callback function associated with
 * the specified GPIO<br>.  This function must be called from the EXTI line detection callbacks
 * function (HAL_GPIO_EXTI_Callback) on the application side.
 *
...
#define CYHAL_GET_PIN(pin)      ((uint32_t)(((uint32_t)pin) & GPIO_PIN_MASK))
