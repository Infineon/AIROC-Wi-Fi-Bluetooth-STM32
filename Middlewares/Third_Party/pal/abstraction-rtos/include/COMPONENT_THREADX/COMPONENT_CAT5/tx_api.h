...
typedef struct TX_TIMER_STRUCT
{
    ...
    * tx_timer_created_previous;
    ...
    #endif // ifdef TX_TIMER_ENABLE_PERFORMANCE_INFO
} TX_TIMER;
...
typedef struct TX_THREAD_STRUCT
{
    ...
    * tx_thread_performance_last_preempting_thread;
    ...
    #endif // ifdef TX_THREAD_ENABLE_PERFORMANCE_INFO
    ...
    /* Note that in ThreadX 5.x, user would define TX_ENABLE_EXECUTION_CHANGE_NOTIFY and use
       TX_THREAD_EXTENSION_3
       to define the following two variables.
       For Azure RTOS 6, user shall use TX_EXECUTION_PROFILE_ENABLE instead of
...
typedef struct TX_BLOCK_POOL_STRUCT
{
    ...
    * tx_block_pool_created_previous;
    ...
    #endif // ifdef TX_BLOCK_POOL_ENABLE_PERFORMANCE_INFO
...
typedef struct TX_BYTE_POOL_STRUCT
{
    ...
    * tx_byte_pool_created_previous;
    ...
    #endif // ifdef TX_BYTE_POOL_ENABLE_PERFORMANCE_INFO
...
typedef struct TX_EVENT_FLAGS_GROUP_STRUCT
{
    ...
    * tx_event_flags_group_created_previous;
    ...
    #endif // ifdef TX_EVENT_FLAGS_ENABLE_PERFORMANCE_INFO
...
typedef struct TX_MUTEX_STRUCT
{
    ...
    * tx_mutex_owned_previous;
    ...
    #endif // ifdef TX_MUTEX_ENABLE_PERFORMANCE_INFO
...
typedef struct TX_QUEUE_STRUCT
{
    ...
    * tx_queue_created_previous;
    ...
    #endif // ifdef TX_QUEUE_ENABLE_PERFORMANCE_INFO
...
typedef struct TX_SEMAPHORE_STRUCT
{
    ...
    * tx_semaphore_created_previous;
    ...
    #endif // ifdef TX_SEMAPHORE_ENABLE_PERFORMANCE_INFO
...
#else // ifdef TX_DISABLE_ERROR_CHECKING
...
#define tx_block_pool_create(p, n, b, s, \
                             l)             \
...
#define tx_byte_pool_create(p, n, s, \
                            l)                \
...
#define tx_mutex_create(m, n, \
                        i)                      _txr_mutex_create((m),(n),(i),(sizeof(TX_MUTEX)))
...
#define tx_queue_create(q, n, m, s, \
                        l)                  \
...
#define tx_semaphore_create(s, n, \
                            i)                  \
...
#define tx_thread_create(t, n, e, i, s, l, p, r, c, \
                         a)       \
...
#define tx_timer_create(t, n, e, i, c, r, \
                        a)              \
...
#else // ifdef TX_ENABLE_MULTI_ERROR_CHECKING
...
#define tx_mutex_create(m, n, \
                        i)                      _txe_mutex_create((m),(n),(i),(sizeof(TX_MUTEX)))
...
#endif // ifdef TX_ENABLE_MULTI_ERROR_CHECKING
#endif // ifdef TX_DISABLE_ERROR_CHECKING

#endif // ifndef TX_SOURCE_CODE
...
UINT _tx_event_flags_set(TX_EVENT_FLAGS_GROUP* group_ptr, ULONG flags_to_set,
                         UINT set_option);
UINT _tx_event_flags_set_notify(TX_EVENT_FLAGS_GROUP* group_ptr, VOID (* events_set_notify)(
                                    TX_EVENT_FLAGS_GROUP* notify_group_ptr));
...
UINT _txe_event_flags_set(TX_EVENT_FLAGS_GROUP* group_ptr, ULONG flags_to_set,
                          UINT set_option);
UINT _txe_event_flags_set_notify(TX_EVENT_FLAGS_GROUP* group_ptr, VOID (* events_set_notify)(
                                     TX_EVENT_FLAGS_GROUP* notify_group_ptr));
#ifdef TX_ENABLE_MULTI_ERROR_CHECKING
...
UINT _txr_event_flags_set(TX_EVENT_FLAGS_GROUP* group_ptr, ULONG flags_to_set,
                          UINT set_option);
UINT _txr_event_flags_set_notify(TX_EVENT_FLAGS_GROUP* group_ptr, VOID (* events_set_notify)(
                                     TX_EVENT_FLAGS_GROUP* notify_group_ptr));
#endif // ifdef TX_ENABLE_MULTI_ERROR_CHECKING
...
UINT _tx_queue_send_notify(TX_QUEUE* queue_ptr, VOID (* queue_send_notify)(
                               TX_QUEUE* notify_queue_ptr));
...
UINT _txe_queue_send_notify(TX_QUEUE* queue_ptr, VOID (* queue_send_notify)(
                                TX_QUEUE* notify_queue_ptr));
...
UINT _txr_queue_send_notify(TX_QUEUE* queue_ptr, VOID (* queue_send_notify)(
                                TX_QUEUE* notify_queue_ptr));
...
UINT _tx_semaphore_put_notify(TX_SEMAPHORE* semaphore_ptr, VOID (* semaphore_put_notify)(
                                  TX_SEMAPHORE* notify_semaphore_ptr));
...
UINT _txe_semaphore_put_notify(TX_SEMAPHORE* semaphore_ptr, VOID (* semaphore_put_notify)(
                                   TX_SEMAPHORE* notify_semaphore_ptr));
#ifdef TX_ENABLE_MULTI_ERROR_CHECKING
...
UINT _txr_semaphore_put_notify(TX_SEMAPHORE* semaphore_ptr, VOID (* semaphore_put_notify)(
                                   TX_SEMAPHORE* notify_semaphore_ptr));
#endif // ifdef TX_ENABLE_MULTI_ERROR_CHECKING
...
UINT _tx_thread_entry_exit_notify(TX_THREAD* thread_ptr, VOID (* thread_entry_exit_notify)(
                                      TX_THREAD* notify_thread_ptr, UINT type));
...
UINT _tx_thread_performance_system_info_get(ULONG* resumptions, ULONG* suspensions,
                                            ...
                                            ULONG* priority_inversions,
                                            ULONG* time_slices, ULONG* relinquishes,
...
UINT _txe_thread_entry_exit_notify(TX_THREAD* thread_ptr, VOID (* thread_entry_exit_notify)(
                                       TX_THREAD* notify_thread_ptr, UINT type));
...
UINT _txr_thread_entry_exit_notify(TX_THREAD* thread_ptr, VOID (* thread_entry_exit_notify)(
                                       TX_THREAD* notify_thread_ptr, UINT type));
...
UINT _txe_timer_create(TX_TIMER* timer_ptr, CHAR* name_ptr,
                       VOID (* expiration_function)(
                           ULONG input), ULONG expiration_input,
...
/* Add a default macro that can be re-defined in tx_port.h to add default processing when a thread
   starts. Common usage
   would be for enabling floating point for a thread by default, however, the additional processing
      could be anything
...
VOID _tx_misra_trace_event_insert(ULONG event_id, VOID* info_field_1, ULONG info_field_2,
...
VOID _tx_misra_event_flags_set_notify_not_used(VOID (* events_set_notify)(
                                                   TX_EVENT_FLAGS_GROUP* notify_group_ptr));
...
VOID _tx_misra_semaphore_put_notify_not_used(VOID (* semaphore_put_notify)(
                                                 TX_SEMAPHORE* notify_semaphore_ptr));
VOID _tx_misra_thread_not_used(TX_THREAD* thread_ptr);
VOID _tx_misra_thread_entry_exit_notify_not_used(VOID (* thread_entry_exit_notify)(
                                                     TX_THREAD* notify_thread_ptr, UINT id));

#define TX_MEMSET(a, b, \
                  c)                                _tx_misra_memset((a), (UINT) (b), (UINT) (c))
...
#define TX_TIMER_POINTER_DIF(a, \
                             b)                       \
    _tx_misra_timer_pointer_dif((TX_TIMER_INTERNAL **) (a), (TX_TIMER_INTERNAL **) (b))
...
#endif
#endif // ifdef TX_SAFETY_CRITICAL
...
#endif // ifdef TX_ENABLE_EVENT_LOGGING
