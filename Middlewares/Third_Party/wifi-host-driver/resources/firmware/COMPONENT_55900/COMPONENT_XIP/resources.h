...
extern const unsigned char wifi_firmware_image_data[509880];
#endif /* !WLAN_MFG_FIRMWARE */

#ifdef WLAN_MFG_FIRMWARE
extern const resource_hnd_t wifi_mfg_firmware_image;
extern const unsigned char wifi_mfg_firmware_image_data[565716];
#endif /* WLAN_MFG_FIRMWARE */

#ifdef DOWNLOAD_RAM_BOOTLOADER
extern const resource_hnd_t wifi_bootloader_image;
extern const unsigned char wifi_bootloader_image_data[63792];
