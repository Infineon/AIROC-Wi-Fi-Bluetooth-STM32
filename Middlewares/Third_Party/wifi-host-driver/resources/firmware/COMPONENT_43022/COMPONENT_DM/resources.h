...
/* For 43022DM Boards - Sinec TRX Header and FW are downloaded at different RAM location, move the FW pointer to offset after TRX Header */
extern const unsigned char wifi_firmware_image_data[374412];
#endif /* !WLAN_MFG_FIRMWARE */
#ifdef WLAN_MFG_FIRMWARE
extern const resource_hnd_t wifi_mfg_firmware_image;
extern const unsigned char wifi_mfg_firmware_image_data[374472];
#endif /* WLAN_MFG_FIRMWARE */
