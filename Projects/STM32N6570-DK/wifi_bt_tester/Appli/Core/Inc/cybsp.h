...
/*----------   -----------*/
#define CYBSP_BT_POWER      PF1

/*----------   -----------*/
#define COMMAND_CONSOLE_UART_TX      PE5

/*----------   -----------*/
#define COMMAND_CONSOLE_UART_RX      PE6
...
/*----------   -----------*/
#define CYBSP_WIFI_WL_REG_ON      PD13
