...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  MqttClientTaskHandle = osThreadNew(mqtt_client_task, NULL, &MqttClientTask_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : WIFI_WL_HOST_WAKE_Pin */
  GPIO_InitStruct.Pin = WIFI_WL_HOST_WAKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(WIFI_WL_HOST_WAKE_GPIO_Port, &GPIO_InitStruct);
 ...
 *
 **************************************************************************************************/
static int _num_int1=0;
static int _num_int2=0;
...
/* USER CODE BEGIN Header_mqtt_client_task */
/**
  * @brief  Function implementing the MqttClientTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_mqtt_client_task */
__weak void mqtt_client_task(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
