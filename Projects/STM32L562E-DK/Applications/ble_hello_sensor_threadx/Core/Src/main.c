...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, GPIO_PIN_4|GPIO_PIN_5|LCD_RST_Pin|STMOD_SEL_12_Pin
  ...
  /*Configure GPIO pins : PF4 PF5 LCD_RST_Pin STMOD_SEL_12_Pin
                           STMOD_SEL_34_Pin CTP_RST_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_4|GPIO_PIN_5|LCD_RST_Pin|STMOD_SEL_12_Pin
                          |STMOD_SEL_34_Pin|CTP_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
