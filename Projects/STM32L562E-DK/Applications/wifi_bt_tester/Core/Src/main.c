...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, WIFI_WL_REG_ON_Pin|LCD_RST_Pin|STMOD_SEL_12_Pin|STMOD_SEL_34_Pin
  ...
  /*Configure GPIO pins : GYRO_ACC_INT_Pin SDIO_DETECT_Pin */
  GPIO_InitStruct.Pin = GYRO_ACC_INT_Pin|SDIO_DETECT_Pin;
  ...
  /*Configure GPIO pins : WIFI_WL_REG_ON_Pin LCD_RST_Pin STMOD_SEL_12_Pin STMOD_SEL_34_Pin
                           CTP_RST_Pin */
  GPIO_InitStruct.Pin = WIFI_WL_REG_ON_Pin|LCD_RST_Pin|STMOD_SEL_12_Pin|STMOD_SEL_34_Pin
                          |CTP_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
__weak void console_task(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* USER CODE END 5 */
}
