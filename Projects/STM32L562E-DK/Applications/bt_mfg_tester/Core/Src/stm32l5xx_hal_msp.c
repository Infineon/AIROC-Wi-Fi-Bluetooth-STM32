...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB10     ------> USART3_TX
    */
    GPIO_InitStruct.Pin = CYBSP_BT_UART_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init(CYBSP_BT_UART_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CYBSP_BT_UART_CTS_Pin|CYBSP_BT_UART_RTS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    ...
    GPIO_InitStruct.Pin = CYBSP_BT_UART_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init(CYBSP_BT_UART_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB10     ------> USART3_TX
    */
    HAL_GPIO_DeInit(CYBSP_BT_UART_RX_GPIO_Port, CYBSP_BT_UART_RX_Pin);

    HAL_GPIO_DeInit(GPIOD, CYBSP_BT_UART_CTS_Pin|CYBSP_BT_UART_RTS_Pin);

    HAL_GPIO_DeInit(CYBSP_BT_UART_TX_GPIO_Port, CYBSP_BT_UART_TX_Pin);
