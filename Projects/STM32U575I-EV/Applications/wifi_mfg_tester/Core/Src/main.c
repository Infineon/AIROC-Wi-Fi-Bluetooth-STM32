...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, WIFI_WL_REG_ON_Pin|LED_GREEN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_BL_CTRL_Pin|GPIO_PIN_4, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_BL_CTRL_Pin PA4 */
